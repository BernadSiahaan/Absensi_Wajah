...
Public Class Form1
    ...
    Private Sub TrainFace()
        Try
            ...
            gray = grabber.QueryGrayFrame().Resize(675, 374, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC)
    ...
    Private Sub pbMazimize_MouseHover(sender As Object, e As EventArgs) Handles pbMazimize.MouseHover
        pbMazimize.Image = Aplikasi_Absensi_Wajah.My.Resources.close
    End Sub

    Private Sub pbMazimize_MouseLeave(sender As Object, e As EventArgs) Handles pbMazimize.MouseLeave
        pbMazimize.Image = Aplikasi_Absensi_Wajah.My.Resources.cancel
    End Sub

    Private Sub pbMinimize_MouseHover(sender As Object, e As EventArgs) Handles pbMinimize.MouseHover
        pbMinimize.Image = Aplikasi_Absensi_Wajah.My.Resources.minimize__1_
    End Sub

    Private Sub pbMinimize_MouseLeave(sender As Object, e As EventArgs) Handles pbMinimize.MouseLeave
        pbMinimize.Image = Aplikasi_Absensi_Wajah.My.Resources.minimize
    End Sub
...
#End Region
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        'Get the current frame form capture device
        currentFrame = grabber.QueryFrame().Resize(675, 374, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC)
